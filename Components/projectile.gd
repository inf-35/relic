...
var patterns : Array = [] #patterns for child bullets
var local_patterns : Array = []
var child_projectiles : Dictionary = {} #references to child bullets
var projectiles_destroyed : int = 0
var numbers_taken : int = 0
